...
router.post('/addnote', fetchuser, [
    body('title', "Please ensure title is atleast 3 charcters").isLength({ min: 3 }),
    body('description', "Please ensure title is atleast 5 charcters").isLength({ min: 5 })
], async (req, res) => {
    try {
...
router.delete('/deletenote/:id', fetchuser, async (req, res) => {
    ...
    try {
        ...
        res.json({ "Sucsess": "Note have been deleted", note: note });
